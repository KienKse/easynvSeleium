...
public class PassCript {
    ...
    private static final int TMS = 10;
    ...
    public static String sendHash(String encodedString) {
        byte[] decodedBytes = Base64.getDecoder().decode(encodedString);
        String decodedString = new String(decodedBytes);
        byte[] decodedByte = decodedBytes;
        for(int i = 1; i < TMS; i++) {
            decodedByte = Base64.getDecoder().decode(decodedByte);
